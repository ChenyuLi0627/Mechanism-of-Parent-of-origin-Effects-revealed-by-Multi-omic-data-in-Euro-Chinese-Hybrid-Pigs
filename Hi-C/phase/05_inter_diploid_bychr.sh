...
#SBATCH -N 1 -n 10
#SBATCH -e /home/gemeichenyu/log/phase_diploid_inter_job-%j_%a.err
#SBATCH -o /home/gemeichenyu/log/phase_diploid_inter_job-%j_%a.log
#SBATCH -p all
#SBATCH --mem=30Gb
#SBATCH -a 1-19
...
batch= #The library of one sample
...
awk  -v chr=$chr '($2==chr && $2!=$6 &&  $9 >= 30 && $12 >= 30)' ${OUTPUT}/merged_nodups.txt > ${sample}_${batch}_merged_nodups_${chr}_inter.txt
${juiceDir}/scripts/common/diploid.pl -s /home/tmpdir/Lichenyu/${sample}/${sample}_chr_pos.txt  -o /home/tmpdir/Lichenyu/${sample}/${sample}_paternal_maternal.txt ${sample}_${batch}_merged_nodups_${chr}_inter.txt > ${sample}_${batch}_diploid_${chr}_inter.txt
#wc -l ${sample}_${batch}_merged_nodups_${chr}.txt ${sample}_${batch}_diploid_${chr}.txt
#######CP BACK AND SAVE YOUR RESULTS #####################
cp ${sample}_${batch}_diploid_${chr}_inter.txt  ${OUTPUT}
