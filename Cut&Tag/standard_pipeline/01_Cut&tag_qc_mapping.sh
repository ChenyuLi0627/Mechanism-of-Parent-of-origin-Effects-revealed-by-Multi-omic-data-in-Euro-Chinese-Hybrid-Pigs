...
/home/Lichenyu/soft/bowtie2-2.5.1-linux-x86_64/bowtie2  --end-to-end --very-sensitive --no-mixed --no-discordant -p 40 -x /home/Lichenyu/ref/DRC_botie2/DRC.MotherHap.fa  -1 ${name}_QC_1.fq.gz   -2 ${name}_QC_2.fq.gz -S ${name}.sam 2> ${name}_bowtie2.txt
rm *fq.gz
#deduplicate
