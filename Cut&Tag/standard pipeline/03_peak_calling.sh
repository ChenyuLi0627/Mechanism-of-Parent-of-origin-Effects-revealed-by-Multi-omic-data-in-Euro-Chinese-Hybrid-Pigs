...
singularity  exec ~/../guilu/software/142.macs.sif macs2 callpeak -f BAMPE  -t /home/gemeichenyu/transfer/cuttag/bin_coverage/${outputfile}_bowtie2.mapped.bam  -n ${outputfile} -g 2682231099 --outdir /home/gemeichenyu/transfer/cuttag/bin_coverage  --bdg -q 0.05  --nomodel --shift -0  --keep-dup all
