...
cd ${tmpdir}/${Work_dir}
inputfile=`cat ${output}/sample.txt|head -${PBS_ARRAYID}|tail -1`
...
singularity exec -B ${tmpdir}/${Work_dir}:${tmpdir}/${Work_dir}  /home/Singusoft/hisat2.sif  hisat2 -p $nprocs -x  /home/Lichenyu/ref/DRC/DRC.MotherHap.fa -I 0 --qc-filter -X 500  -1 ${INPUT}/${name}_1.clean.fq.gz -2 ${INPUT}/${name}_2.clean.fq.gz  -S ${name}.sam
