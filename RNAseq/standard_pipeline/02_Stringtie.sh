...
/home/PersonalFiles/rnaqc/soft/stringtie-master/stringtie    ${inputfile} --rf -p 10 -o ${outputfile}_transcript.gtf -A ${outputfile}.tsv  -G /home/Lichenyu/ref/DRCv19_mother_DRCv20_liftoff.sorted.gtf -e
